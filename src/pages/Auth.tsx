  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        {signupDone ? (
          <div className="bg-bg-elevated border border-accent-success rounded-2xl p-6 text-center">
            <p className="text-3xl mb-3">📧</p>
            <p className="text-text-primary font-bold mb-1">Check your email</p>
            <p className="text-text-secondary text-sm">
              We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.
            </p>
            <button
              onClick={() => { setSignupDone(false); setMode('login') }}
              className="mt-4 text-accent-red text-sm font-semibold"
            >
              Back to sign in
            </button>
          </div>
